...
```bash
git clone -b shift-3642 git@shift.gitlab.yandexcloud.net:shift-python/y2025/homeworks/kozlov-l/shift_project.git
cd shift_project
```
...
### 4. Запуск сервиса
```bash
poetry run --directory user-data-service uvicorn app.service:app
```
