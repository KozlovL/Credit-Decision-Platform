...
* **antifraud-service** — сервис антифрода для проверки бизнес-правил пользователей PIONEER и REPEATER.
...
* Документация: `http://127.0.0.1:8003/docs`
...
### scoring-service — скоринг первичных пользователей (PIONEER)
...
### antifraud-service — проверки PIONEER и REPEATER

#### POST /api/antifraud/pioneer/check

**Назначение**: Проверка первичных пользователей.
...
**Назначение**: Проверка повторных пользователей.
...
> Все ошибки интеграции (например, Data Service или Redis недоступен) возвращают `502 Bad Gateway`.
...
Адрес Grafana: `http://158.160.193.181:30030/`

### 🔎 Jaeger

Адрес Jaeger: `http://158.160.193.181:30040/search`

> Позволяет смотреть распределённые трейсинг-сессии всех сервисов, включая antifraud-service.
